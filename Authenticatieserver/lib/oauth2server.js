...
Returns middleware that is able to validate an accesstoken
*/
OAuth2Server.prototype.check = function () {
  var self = this;

  return function (req, res, next) {
    return new Check(self, req, res);
  };
};


/*
Logout. This deletes the accesstoken on serverside.

*/
OAuth2Server.prototype.logout = function () {
  var self = this;

  return function (req, res, next) {
    return new Logout(self, req, res);
  };
};
