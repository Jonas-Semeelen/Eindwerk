...
var CodePush = (function () {
    ...
    CodePush.prototype.checkForUpdate = function (querySuccess, queryError, deploymentKey) {
        console.log("checkForUpdate gebeurt");
        try {
                ...
                if (error) {
                    ...
                    if (remotePackageOrUpdateNotification) {
                        if (remotePackageOrUpdateNotification.updateAppVersion) {
                            ...
                            CodePushUtil.logMessage("remotePackageOrUpdateNotification: " + remotePackageOrUpdateNotification);
                    ...
                    if (initError) {
                        ...
                        LocalPackage.getCurrentOrDefaultPackage(function (localPackage) {
                            NativeAppInfo.getApplicationVersion(function(appVersionError, currentBinaryVersion) {
                                ...
                                /*
                                Hier wordt de request naar de server verzonden om te vragen of er een update beschikbaar is.
                                Dit gebeurt in acquisition-sdk.js op lijn 35.
                                */
            ...
            /*
            door de default syncOptions is de deploymentkey 'undefined'. Hierdoor wordt er niet in de 'if' gegaan, maar wel in de 'else'.
            */
            if (deploymentKey) {
                CodePushUtil.logMessage("Normale deploymentkey: "+ deploymentKey);
                queryUpdate();
            }
            else {
                /*
                De default deploymentkey wordt uit de preferences in config.xml gehaald. In die file moet de ontwikkelaar de gegeven key invullen. 
                */
                NativeAppInfo.getDeploymentKey(function (deploymentKeyError, defaultDeploymentKey) {
                    if (deploymentKeyError) {
                        ...
                        CodePushUtil.logMessage("default deploymentkey: "+ defaultDeploymentKey);
